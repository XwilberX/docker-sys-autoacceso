...
function enviar_formulario_ajax(e){
	...
	if(tipo==="save"){
		...
		texto_alerta="Se eliminará la búsqueda actual, deberás ingresar una nueva búsqueda";
	}else if(tipo==="cancel_advisory"){
		texto_alerta="¿Desea cancelar la asesoría seleccionada?";
	} else{
