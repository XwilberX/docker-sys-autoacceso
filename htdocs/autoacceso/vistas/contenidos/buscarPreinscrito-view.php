...
<div class="g3-table">
    ...
    <form class="FormularioAjax" action="<?php echo SERVERURL;?>ajax/buscadorAjax.php" method="POST" data-form="default" autocomplete="off">
      <input type="hidden" name="modulo" id="" value="preinscrito">
<div>
...
<?php  
  ...
  if(isset($_SESSION['busqueda_preinscrito']) && $_SESSION['busqueda_preinscrito']!=""){
    $busqueda=$_SESSION['busqueda_preinscrito'];
  ?>  
  ...
  echo $ins_preinscrito->paginador_preinscrito_controlador($pagina[1],5,$_SESSION['privilegio_scaa'],$_SESSION['curp_scaa'],$pagina[0], $busqueda);
