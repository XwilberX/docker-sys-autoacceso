...
if($_SESSION['id_scaa']!=$pagina[1]){
 ...
 <div class="formContainer3" >
    ...
    <div class="g3-table">
     ...
     <h2>Lista de solicitudes de inscripción</h2>
...
<?php 
  ...
  echo $ins_preinscrito->paginador_preinscrito_controlador($pagina[1],10,$_SESSION['privilegio_scaa'],$_SESSION['curp_scaa'],$pagina[0],"");
