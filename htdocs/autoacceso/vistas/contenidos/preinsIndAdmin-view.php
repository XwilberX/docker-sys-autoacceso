...
<input type="hidden" name="preins_id_decrypt" value=" <?php echo $pagina[1]; ?> "> 
  ...
  <input type="text" class="txtBox" required="" name="apellido_materno_reg" placeholder="ej:Ruiz" minlength="1" maxlength="50" pattern="[a-z A-Z áéíóúüñÁÉÍÓÚÜÑ]{1,50}" value="<?php echo $campos['apellido_materno']; ?>">
    ...
    <label for="">Correo personal: </label> <input type="email" class="txtBox" minlength="5" maxlength="100" pattern="[a-z0-9@._/-]{5,100}" name="correo_reg" placeholder="ejemplo@email.com" value="<?php echo $campos['correo']; ?>">
    <label for="">Correo UNACH: </label> <input type="email" class="txtBox" pattern="[a-z0-9@._/-]{5,100}" name="correo_unach_reg" placeholder="ejemplo@unach.mx" value="<?php echo $campos['correo_unach']; ?>"><br>
    <label for="">Calle: </label> <input type="text"class="txtBox" name="calle_reg" minlength="2" maxlength="50" pattern="[a-z A-Z áéíóúñÁÉÍÓÚÑ. 0-9]{0,50}" placeholder="ej:2a oriente" value="<?php echo $campos['calle']; ?>"><br>
    <label for="">Número: </label> <input type="text" class="txtBox" name="num_reg" minlength="1" maxlength="5" pattern="[0-9]{0,5}" placeholder="ej:182" value="<?php echo $campos['numero']; ?>">
