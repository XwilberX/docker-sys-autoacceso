...
<label for="">*Email: </label> <input type="email" class="txtBox" pattern="[a-z0-9@._/-]{5,100}" name="correo_reg" placeholder="ejemplo@email.com" required> 
<label for="">*Calle: </label> <input type="text"class="txtBox" name="calle_reg" required="" pattern="[a-z A-Z áéíóúñÁÉÍÓÚÑ 0-9]{2,50}" placeholder="ej:2a oriente">
<label for="">*Número: </label> <input type="text" class="txtBox" name="num_reg" required="" pattern="[0-9]{1,5}" placeholder="ej:182"><br> 
