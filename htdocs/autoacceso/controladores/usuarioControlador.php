		...
		public function agregar_usuario_controlador(){
			...
			if($curp=="" || $nombre=="" || $apellido_paterno=="" || $apellido_materno=="" || $calle=="" || $numero=="" || $colonia=="" || $telefono=="" ||  $password=="" || $confirmPass==""){
				...
				/* VERIFICAR LA INTEGRIDAD DE LOS DATOS */
					...
					if(mainModel::verificar_datos("[a-z A-Z áéíóúüñÁÉÍÓÚÜÑ]{3,50}",$nombre)){
						$alerta=[
						"Alerta"=>"simple",
						"Titulo"=>"Ocurrio un error inesperado",
...
/*
			...
			public function paginador_usuario_controlador($pagina, $registros, $privilegio, $curp, $url, $busqueda){
				...
				if(isset($busqueda) && $busqueda !=""){
                    ...
                    $consulta2="SELECT * FROM persona JOIN rol ON persona.id_rol=rol.id_rol JOIN idioma ON persona.idioma_asesor=idioma.id_idioma WHERE (persona.nombre LIKE '%$busqueda%' OR persona.apellido_paterno LIKE '%$busqueda%' OR persona.apellido_materno LIKE '%$busqueda%' OR persona.telefono LIKE '%$busqueda%' OR persona.curp LIKE '%$busqueda%') AND persona.curp!='$curp' AND persona.id_persona!='9'AND persona.curp!='1' AND persona.id_rol!='6' AND persona.id_rol!='7' AND persona.id_rol!='8' ORDER BY persona.apellido_paterno ASC";
					
					$consulta="SELECT * FROM persona JOIN rol ON persona.id_rol=rol.id_rol JOIN idioma ON persona.idioma_asesor=idioma.id_idioma WHERE (persona.nombre LIKE '%$busqueda%' OR persona.apellido_paterno LIKE '%$busqueda%' OR persona.apellido_materno LIKE '%$busqueda%' OR persona.telefono LIKE '%$busqueda%' OR persona.curp LIKE '%$busqueda%') AND persona.curp!='$curp' AND persona.id_persona!='9'AND persona.curp!='1' AND persona.id_rol!='6' AND persona.id_rol!='7' AND persona.id_rol!='8' ORDER BY persona.apellido_paterno ASC LIMIT $inicio,$registros";

					$consulta3="SELECT * FROM persona JOIN rol ON persona.id_rol=rol.id_rol JOIN idioma ON persona.idioma_asesor=idioma.id_idioma WHERE (persona.nombre LIKE '%$busqueda%' OR persona.apellido_paterno LIKE '%$busqueda%' OR persona.apellido_materno LIKE '%$busqueda%' OR persona.telefono LIKE '%$busqueda%' OR persona.curp LIKE '%$busqueda%') AND persona.curp!='$curp' AND persona.id_persona!='9'AND persona.curp!='1' AND persona.id_rol!='6' AND persona.id_rol!='7' AND persona.id_rol!='8' ORDER BY persona.apellido_paterno ASC";

				
				}else{
					
				$consulta2="SELECT * FROM persona JOIN rol ON persona.id_rol=rol.id_rol JOIN idioma ON persona.idioma_asesor=idioma.id_idioma WHERE persona.id_persona!='9' AND persona.curp!='$curp' AND persona.id_rol!='6' AND persona.id_rol!='7' AND persona.id_rol!='8' ORDER BY persona.apellido_paterno ASC";

					$consulta="SELECT * FROM persona JOIN rol ON persona.id_rol=rol.id_rol JOIN idioma ON (persona.idioma_asesor=idioma.id_idioma)WHERE persona.id_persona!='9' AND curp!='$curp' AND rol.id_rol!='6' AND rol.id_rol!='7' AND rol.id_rol!='8' ORDER BY persona.apellido_paterno ASC LIMIT $inicio,$registros";

					$consulta3="SELECT * FROM persona WHERE persona.id_persona!='9' AND curp!='$curp' AND id_rol!='6' AND id_rol!='7' AND id_rol!='8' ORDER BY apellido_paterno ASC";
				...
				$tabla.='
						...
						<tr class="text-center" >
			                ...
			                <td data-label="Privilegios">'.$rows['etiqueta_rol'].'</td>
		...
		public function editar_usuario_controlador(){
			...
			public function obtener_asesores_controlador(){

			return usuarioModelo::obtener_asesores_modelo();
