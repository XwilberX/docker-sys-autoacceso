<?php 
	...
	class reporteEscritosControlador extends reportesModelo{
		public function reporte_escritos_controlador(){
			...
			$trimestre=mainModel::limpiar_cadena($_POST['escritos']);
