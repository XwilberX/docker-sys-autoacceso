<?php 
			...
			$consulta104=$mbd->prepare("SELECT COUNT(completada) FROM asesorias JOIN curso_asesorias ON asesorias.id_curso=curso_asesorias.id_curso_asesoria JOIN persona ON curso_asesorias.id_persona_alumno=persona.id_persona WHERE asesorias.completada=1 AND persona.carrera_unach=17 AND persona.carrera_unach=74 AND asesorias.fecha_asesoria BETWEEN '$enero' AND '$enero2'");
			$consulta104->execute();
			$dato104 = $consulta104->fetch();

			$consulta105=$mbd->prepare("SELECT COUNT(completada) FROM asesorias JOIN curso_asesorias ON asesorias.id_curso=curso_asesorias.id_curso_asesoria JOIN persona ON curso_asesorias.id_persona_alumno=persona.id_persona WHERE asesorias.completada=1 AND persona.carrera_unach=17 AND persona.carrera_unach=74 AND asesorias.fecha_asesoria BETWEEN '$febrero' AND '$febrero2'");
			$consulta105->execute();
			$dato105 = $consulta105->fetch();

			$consulta106=$mbd->prepare("SELECT COUNT(completada) FROM asesorias JOIN curso_asesorias ON asesorias.id_curso=curso_asesorias.id_curso_asesoria JOIN persona ON curso_asesorias.id_persona_alumno=persona.id_persona WHERE asesorias.completada=1 AND persona.carrera_unach=17 AND persona.carrera_unach=74 AND asesorias.fecha_asesoria BETWEEN '$marzo' AND '$marzo2'");
			$consulta106->execute();
			$dato106 = $consulta106->fetch();

			$consulta107=$mbd->prepare("SELECT COUNT(completada) FROM asesorias JOIN curso_asesorias ON asesorias.id_curso=curso_asesorias.id_curso_asesoria JOIN persona ON curso_asesorias.id_persona_alumno=persona.id_persona WHERE asesorias.completada=1 AND persona.carrera_unach=17 AND persona.carrera_unach=74 AND asesorias.fecha_asesoria BETWEEN '$abril' AND '$abril2'");
			$consulta107->execute();
			$dato107 = $consulta107->fetch();

			$consulta108=$mbd->prepare("SELECT COUNT(completada) FROM asesorias JOIN curso_asesorias ON asesorias.id_curso=curso_asesorias.id_curso_asesoria JOIN persona ON curso_asesorias.id_persona_alumno=persona.id_persona WHERE asesorias.completada=1 AND persona.carrera_unach=17 AND persona.carrera_unach=74 AND asesorias.fecha_asesoria BETWEEN '$mayo' AND '$mayo2'");
			$consulta108->execute();
			$dato108 = $consulta108->fetch();

			$consulta109=$mbd->prepare("SELECT COUNT(completada) FROM asesorias JOIN curso_asesorias ON asesorias.id_curso=curso_asesorias.id_curso_asesoria JOIN persona ON curso_asesorias.id_persona_alumno=persona.id_persona WHERE asesorias.completada=1 AND persona.carrera_unach=17 AND persona.carrera_unach=74 AND asesorias.fecha_asesoria BETWEEN '$junio' AND '$junio2'");
			$consulta109->execute();
			$dato109 = $consulta109->fetch();

			$consulta110=$mbd->prepare("SELECT COUNT(completada) FROM asesorias JOIN curso_asesorias ON asesorias.id_curso=curso_asesorias.id_curso_asesoria JOIN persona ON curso_asesorias.id_persona_alumno=persona.id_persona WHERE asesorias.completada=1 AND persona.carrera_unach=17 AND persona.carrera_unach=74 AND asesorias.fecha_asesoria BETWEEN '$julio' AND '$julio2'");
			$consulta110->execute();
			$dato110 = $consulta110->fetch();

			$consulta111=$mbd->prepare("SELECT COUNT(completada) FROM asesorias JOIN curso_asesorias ON asesorias.id_curso=curso_asesorias.id_curso_asesoria JOIN persona ON curso_asesorias.id_persona_alumno=persona.id_persona WHERE asesorias.completada=1 AND persona.carrera_unach=17 AND persona.carrera_unach=74 AND asesorias.fecha_asesoria BETWEEN '$agosto' AND '$agosto2'");
			$consulta111->execute();
			$dato111 = $consulta111->fetch();

			$consulta112=$mbd->prepare("SELECT COUNT(completada) FROM asesorias JOIN curso_asesorias ON asesorias.id_curso=curso_asesorias.id_curso_asesoria JOIN persona ON curso_asesorias.id_persona_alumno=persona.id_persona WHERE asesorias.completada=1 AND persona.carrera_unach=17 AND persona.carrera_unach=74 AND asesorias.fecha_asesoria BETWEEN '$septiembre' AND '$septiembre2'");
			$consulta112->execute();
			$dato112 = $consulta112->fetch();

			$consulta113=$mbd->prepare("SELECT COUNT(completada) FROM asesorias JOIN curso_asesorias ON asesorias.id_curso=curso_asesorias.id_curso_asesoria JOIN persona ON curso_asesorias.id_persona_alumno=persona.id_persona WHERE asesorias.completada=1 AND persona.carrera_unach=17 AND persona.carrera_unach=74 AND asesorias.fecha_asesoria BETWEEN '$octubre' AND '$octubre2'");
			$consulta113->execute();
			$dato113 = $consulta113->fetch();

			$consulta114=$mbd->prepare("SELECT COUNT(completada) FROM asesorias JOIN curso_asesorias ON asesorias.id_curso=curso_asesorias.id_curso_asesoria JOIN persona ON curso_asesorias.id_persona_alumno=persona.id_persona WHERE asesorias.completada=1 AND persona.carrera_unach=17 AND persona.carrera_unach=74 AND asesorias.fecha_asesoria BETWEEN '$noviembre' AND '$noviembre2'");
			$consulta114->execute();
			...
			$consulta117=$mbd->prepare("SELECT COUNT(completada) FROM asesorias JOIN curso_asesorias ON asesorias.id_curso=curso_asesorias.id_curso_asesoria JOIN persona ON curso_asesorias.id_persona_alumno=persona.id_persona WHERE asesorias.completada=1 AND persona.carrera_unach=17 AND persona.carrera_unach=74 AND asesorias.fecha_asesoria BETWEEN '$enero' AND '$diciembre2'");
			$consulta117->execute();
